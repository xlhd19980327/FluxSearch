#source("./lipidFluxSearch_functions_0.5.1.R")
source("./lipidFluxSearch_lfsRevised.R")
...
## For Windows path
xmlfiles <- gsub("\\", "/", xmlfiles, fixed = T)
C12files <- gsub("\\", "/", C12files, fixed = T)
resultout <- gsub("\\", "/", resultout, fixed = T)
#print(xmlin)
